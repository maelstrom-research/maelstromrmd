# create an html dependency for Magnific popup (function copied from rmdformats)
html_dependency_magnific_popup <- function() {
    htmltools::htmlDependency("magnific-popup",
                              "1.1.0",
                              system.file("templates/magnific-popup-1.1.0",
                                          package = "maelstromrmd"),
                              script = "jquery.magnific-popup.min.js",
                              stylesheet = "magnific-popup.css")
}

# create an html dependency for jquery-stickytableheaders (function copied from rmdformats)
...
html_dependency_bootstrap <- function(theme = "bootstrap") {
    htmltools::htmlDependency(name = "bootstrap",
                              version = "3.3.6",
                              src = system.file("templates/bootstrap-3.3.6",
                                                package = "maelstromrmd"),
                              ...
                              stylesheet = paste("css/", theme, ".min.css",
                                                 sep = ""))
}
...
html_dependency_navigation <- function(code_menu = TRUE, source_embed = FALSE) {
    ...
    htmltools::htmlDependency(name = "navigation",
                              version = "1.1",
                              src = system.file("templates/navigation-1.1",
                                                package = "maelstromrmd"),
                              script = script)
}
